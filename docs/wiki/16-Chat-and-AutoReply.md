...
```bash
curl -X GET "https://your-line-worker.workers.dev/api/operators" \
...
```bash
curl -X POST "https://your-line-worker.workers.dev/api/operators" \
  -H "Authorization: Bearer YOUR_API_KEY" \
...
```bash
curl -X PUT "https://your-line-worker.workers.dev/api/operators/OP_UUID" \
  -H "Authorization: Bearer YOUR_API_KEY" \
  -H "Content-Type: application/json" \
...
```bash
curl -X DELETE "https://your-line-worker.workers.dev/api/operators/OP_UUID" \
  -H "Authorization: Bearer YOUR_API_KEY"
```
...
```bash
# 全チャット
curl -X GET "https://your-line-worker.workers.dev/api/chats" \
  -H "Authorization: Bearer YOUR_API_KEY"

# 未読のみ
curl -X GET "https://your-line-worker.workers.dev/api/chats?status=unread" \
  -H "Authorization: Bearer YOUR_API_KEY"

# 特定オペレーター担当
curl -X GET "https://your-line-worker.workers.dev/api/chats?operatorId=OP_UUID" \
  -H "Authorization: Bearer YOUR_API_KEY"

# 組み合わせ
curl -X GET "https://your-line-worker.workers.dev/api/chats?status=in_progress&operatorId=OP_UUID" \
  -H "Authorization: Bearer YOUR_API_KEY"
```
...
```bash
curl -X GET "https://your-line-worker.workers.dev/api/chats/CHAT_UUID" \
  -H "Authorization: Bearer YOUR_API_KEY"
```
...
```bash
curl -X POST "https://your-line-worker.workers.dev/api/chats" \
  -H "Authorization: Bearer YOUR_API_KEY" \
  -H "Content-Type: application/json" \
...
```bash
# オペレーターアサイン + 対応中に変更
curl -X PUT "https://your-line-worker.workers.dev/api/chats/CHAT_UUID" \
  -H "Authorization: Bearer YOUR_API_KEY" \
  -H "Content-Type: application/json" \
...
```bash
# テキストメッセージ送信
curl -X POST "https://your-line-worker.workers.dev/api/chats/CHAT_UUID/send" \
  -H "Authorization: Bearer YOUR_API_KEY" \
  -H "Content-Type: application/json" \
