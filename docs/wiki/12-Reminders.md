...
```bash
curl -X GET "https://your-line-worker.workers.dev/api/reminders" \
...
```bash
curl -X GET "https://your-line-worker.workers.dev/api/reminders/REMINDER_UUID" \
  -H "Authorization: Bearer YOUR_API_KEY"
```
...
```bash
curl -X POST "https://your-line-worker.workers.dev/api/reminders" \
  -H "Authorization: Bearer YOUR_API_KEY" \
...
```bash
curl -X PUT "https://your-line-worker.workers.dev/api/reminders/REMINDER_UUID" \
  -H "Authorization: Bearer YOUR_API_KEY" \
  -H "Content-Type: application/json" \
...
```bash
curl -X DELETE "https://your-line-worker.workers.dev/api/reminders/REMINDER_UUID" \
  -H "Authorization: Bearer YOUR_API_KEY"
```
...
```bash
curl -X POST "https://your-line-worker.workers.dev/api/reminders/REMINDER_UUID/steps" \
  -H "Authorization: Bearer YOUR_API_KEY" \
  -H "Content-Type: application/json" \
  -d '{
    "offsetMinutes": -1440,
...
```bash
curl -X DELETE "https://your-line-worker.workers.dev/api/reminders/REMINDER_UUID/steps/STEP_UUID" \
  -H "Authorization: Bearer YOUR_API_KEY"
```
...
```bash
curl -X POST "https://your-line-worker.workers.dev/api/reminders/REMINDER_UUID/enroll/FRIEND_UUID" \
  -H "Authorization: Bearer YOUR_API_KEY" \
  -H "Content-Type: application/json" \
...
```bash
curl -X GET "https://your-line-worker.workers.dev/api/friends/FRIEND_UUID/reminders" \
  -H "Authorization: Bearer YOUR_API_KEY"
```
...
```bash
curl -X DELETE "https://your-line-worker.workers.dev/api/friend-reminders/FRIEND_REMINDER_UUID" \
  -H "Authorization: Bearer YOUR_API_KEY"
```
