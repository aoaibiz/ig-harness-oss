...
```bash
curl -X GET "https://your-line-worker.workers.dev/api/scoring-rules" \
...
```bash
curl -X GET "https://your-line-worker.workers.dev/api/scoring-rules/RULE_UUID" \
  -H "Authorization: Bearer YOUR_API_KEY"
```
...
```bash
curl -X POST "https://your-line-worker.workers.dev/api/scoring-rules" \
  -H "Authorization: Bearer YOUR_API_KEY" \
...
```bash
curl -X PUT "https://your-line-worker.workers.dev/api/scoring-rules/RULE_UUID" \
  -H "Authorization: Bearer YOUR_API_KEY" \
  -H "Content-Type: application/json" \
...
```bash
curl -X DELETE "https://your-line-worker.workers.dev/api/scoring-rules/RULE_UUID" \
  -H "Authorization: Bearer YOUR_API_KEY"
```
...
```bash
curl -X GET "https://your-line-worker.workers.dev/api/friends/FRIEND_UUID/score" \
  -H "Authorization: Bearer YOUR_API_KEY"
```
...
```bash
# 加算
curl -X POST "https://your-line-worker.workers.dev/api/friends/FRIEND_UUID/score" \
  -H "Authorization: Bearer YOUR_API_KEY" \
  -H "Content-Type: application/json" \
...
```bash
KEY="YOUR_API_KEY"
BASE="https://your-line-worker.workers.dev"
