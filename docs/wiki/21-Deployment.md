...
wrangler pages deploy apps/web/.next --project-name=your-name-admin
```
...
| 変数名 | 説明 |
|--------|------|
| `VITE_LIFF_ID` | LIFF ID（例: `1234567890-AbCdEfGh`） |
...
```
https://your-line-worker.workers.dev
```
...
```bash
# API ヘルスチェック
curl https://your-line-worker.workers.dev/openapi.json

# 認証テスト
curl -H "Authorization: Bearer YOUR_API_KEY" \
  https://your-line-worker.workers.dev/api/friends/count

# Swagger UI
open https://your-line-worker.workers.dev/docs
```
