...
```bash
curl -X GET "https://your-line-worker.workers.dev/api/rich-menus" \
...
```bash
curl -X POST "https://your-line-worker.workers.dev/api/rich-menus" \
  -H "Authorization: Bearer YOUR_API_KEY" \
...
```bash
curl -X POST "https://your-line-worker.workers.dev/api/rich-menus/richmenu-xxx/image" \
  -H "Authorization: Bearer YOUR_API_KEY" \
  -H "Content-Type: application/json" \
...
```bash
curl -X POST "https://your-line-worker.workers.dev/api/rich-menus/richmenu-xxx/default" \
  -H "Authorization: Bearer YOUR_API_KEY"
```
...
```bash
curl -X POST "https://your-line-worker.workers.dev/api/friends/FRIEND_UUID/rich-menu" \
  -H "Authorization: Bearer YOUR_API_KEY" \
  -H "Content-Type: application/json" \
...
```bash
curl -X DELETE "https://your-line-worker.workers.dev/api/friends/FRIEND_UUID/rich-menu" \
  -H "Authorization: Bearer YOUR_API_KEY"
```
...
```bash
curl -X DELETE "https://your-line-worker.workers.dev/api/rich-menus/richmenu-xxx" \
  -H "Authorization: Bearer YOUR_API_KEY"
```
